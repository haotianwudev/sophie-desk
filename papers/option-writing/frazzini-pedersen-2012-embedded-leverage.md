...
- **Rating:** High
- **Rationale:** Foundational economic theory explaining the structural profitability of option writing: leverage-constrained investors overpay for embedded leverage ($\Omega = |\Delta S/F|$), causing short-dated OTM options to produce severe negative alphas (-5% to -10%/month delta-hedged). Directly justifies targeting short 10–25 delta strikes and provides an inverse-leverage sizing rule ($1/\Omega$) to stabilize book volatility.

## Notable Citations to Follow Up

1. **Frazzini, Andrea, and Lasse Heje Pedersen (2014)** — *Betting Against Beta* (Journal of Financial Economics, 111(1), 1-25).
   - Core theoretical and empirical framework establishing that leverage-constrained investors systematically overpay for high-beta and leveraged assets.
2. **Bollen, Nicolas P. B., and Robert E. Whaley (2004)** — *Does Net Buying Pressure Affect the Shape of Implied Volatility Functions?* (Journal of Finance, 59(2), 711-753).
   - Empirically links end-user order flow and net institutional buying pressure to the steepness and curvature of option implied volatility surfaces.
3. **Broadie, Mark, Mikhail Chernov, and Michael Johannes (2009)** — *Understanding Index Option Returns* (Review of Financial Studies, 22(11), 4493-4529).
   - Evaluates whether non-linear option payoff structures and jump risk models can explain the abnormal returns generated by systematic index option writing.
